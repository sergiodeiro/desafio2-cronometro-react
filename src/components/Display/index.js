...
const Display = props => {
  ...
  return (
    <Div className="row">
      <Div style={PonteiroConometro} className={`${props.time.ms>0 && !props.status === 2 ? 'animacao-cronometro animacao-cronometro-active' : 'animacao-cronometro'} ponteiro-resposivo`}></Div>
      <Div style={Relogio}>
